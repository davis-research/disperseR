...
#'
#' @param df A data.frame containing an "x" and a "y" column, representing coordinates. Other information about the data.frame (extra columns) should be retained.
#' @param origin A vector of two numbers representing the desired (x,y) coordinates of the desired origin of the resulting dataframe. This defaults to 0,0, meaning that the left/bottom-most point will be at (0,0)
#'
#' @return This function returns the data.frame from "x", with modified x and y columns.
#' @examples
...
rotatePlot <- function(df, origin=c(0,0)){
