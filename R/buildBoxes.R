...
#'
#' @param x A vector of x values representing the corners of boxes along the X-axis.
#' @param y A vector of y values representing the corners of boxes along the Y-axis.
#'
#' @return The parameters should be generated by getSubplotCoords, or you can enter them manually. This function returns a data.frame listing (x,y) of the corners of each subplot, arbitrarily numbered. The columns are "POINT_X", "POINT_Y", and "Subplot", reflecting the standard format taken by TrapUTM.
#' @export
#'
#' @examples
